  ...
  <div class="flex h-[100dvh] overflow-hidden">
    ...
    >
      ...
      <main class="grow" v-if="restaurant != null">
        <div
          v-if="
            restaurant.relationships.operating_hours.length == 0 ||
            restaurant.attributes.status == 'Denied'
          "
        ...
        >
          ...
          <div class="relative">
            <h1
              v-if="restaurant.relationships.operating_hours.length == 0"
            ...
            <p
              v-if="restaurant.relationships.operating_hours.length == 0"
              class="dark:text-indigo-200 flex gap-1"
            >
              Please
              <span v-if="restaurant.relationships.operating_hours.length == 0"
                ><p>enter</p></span
              >
              <router-link
                v-if="restaurant.relationships.operating_hours.length == 0"
                ...
                :to="{
                  ...
                  params: { uuid: restaurant.uuid },
                }"
              >
                Operating Hours</router-link
              >
            </p>
            <h1
              v-if="restaurant.attributes.status == 'Denied'"
              class="text-2xl md:text-3xl text-slate-800 dark:text-slate-100 font-bold mb-1"
            >
              Branch Status is Denied
            </h1>
            <p
              v-if="restaurant.attributes.status == 'Denied'"
              class="dark:text-indigo-200 flex gap-1"
            >
              {{ restaurant.attributes.denied_reason }}
            </p>
          </div>
        </div>
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
          ...
          <div class="sm:flex sm:justify-between sm:items-center mb-8">
              ...
              <span>
                <div class="flex">
                  ...
                  >
                    ...
                    <span v-if="restaurant.attributes.status == 'Approved'"
                      >✨</span
                    >
                  </h1>
                ...
                <router-link
                  class="btn btn-sm bg-yellow-300 text-slate-900"
                  :to="{
            ...
            <div class="flex gap-2">
              <div class="btn bg-gray-700 text-white">
                Groceries Service Charge on each order:
                {{
                  restaurant.attributes.groceries_service_charge_agreement
                    ? restaurant.attributes.groceries_service_charge_agreement
                    : 0
                }}%
              </div>
              <div class="btn bg-gray-700 text-white">
                Service Charge on each order:
                {{
                  restaurant.attributes.service_charge_agreement
                    ? restaurant.attributes.service_charge_agreement
                    : 0
                }}%
              </div>
              ...
              >
                ...
                <div class="flex gap-2 p-3">
                  <div class="flex flex-col space-y-2 w-[98%]">
                    <h1
                      class="flex gap-2 font-bold text-slate-800 dark:text-slate-100"
                    >
                      <span>Email:</span
                    ...
                    <header class="space-y-6">
                      ...
                      <div class="flex justify-center items-center">
                        <span
                          ...
                          >{{ restaurant.relationships.orders_count }}</span
                        >
                      </div>
                    </header>
                  </div>
                  ...
                  <div class="grow p-5">
                    <header class="space-y-6">
                      ...
                      <div class="flex justify-center items-center">
                        <span
                          class="text-2xl font-medium text-slate-400 -mt-0.5 mr-1"
                          >{{ restaurant.relationships.menus_count }}</span
                        >
                      </div>
                    </header>
                  </div>
                        ...
                        <div class="flex space-x-1">
                          <button>
                            ...
                            <svg
                              ...
                              :class="
                                Math.round(
                                  restaurant.attributes.average_rating
                                ) >= 1
                                  ? 'text-amber-500'
                              ...
                              {{
                                formatValue(
                                  payment.orderable.total_amount -
                                    payment.orderable.delivery_fee,
                                  restaurant.country
                                )
                              }}
                            </div>
          ...
          <div class="grid grid-cols-12 gap-6">
            ...
            >
              ...
              >
                ...
                <button
                  class="btn btn-sm bg-indigo-400 text-black"
                  @click="clearFields('menu')"
                >
                  Add Menu
                </button>
              </header>
                      ...
                      <tr
                        ...
                        :class="
                          menu_item.id === editMenuId
                            ? 'bg-slate-200 transition duration-200 ease-in-out'
                      ...
                      >
                        ...
                        <td class="p-2">
                          <div class="text-center text-sky-500">
                            {{ menu_item.preparation_time }} mins
                          </div>
                        </td>
                        <td class="p-2">
                          <div class="text-center text-sky-500">
            ...
            >
              ...
              <div class="p-3">
                ...
                <div class="overflow-x-auto relative">
                  <table class="table-auto w-full dark:text-slate-300">
                    ...
                    >
                      ...
                      <tr v-for="table in restaurantTables" :key="table.id">
                        ...
                        <td class="p-2">
                          <div v-if="table.created_at" class="text-sky-500">
                            {{ moment(table.created_at).format("Do MMM Y") }}
                          </div>
                        </td>
                  ...
                  <div class="mt-8">
                    <PaginationClassic
                      @change-page="tablesChangePage"
                      :next_page="nextTablePageUrl"
                      :prev_page="prevTablePageUrl"
                      :from="tablesFrom"
                      :to="tablesTo"
                      :total_items="tablesTotalItems"
                    />
            ...
            >
              <div class="p-3">
                <h1
                  class="text-xl text-slate-800 dark:text-slate-100 font-bold mb-6"
                >
                  {{ table_action == "create" ? "Add" : "Edit" }} Sitting Table
                </h1>
                <!-- Form -->
                <form
                ...
                >
                  <div class="space-y-4">
                    <div>
                      ...
                      <select
                        name="seating-area"
                        v-model="addTableSeatingArea"
                        class="w-full rounded-lg form-select bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                      >
                        <option
                          v-for="seating_area in seatingAreas"
                          :key="seating_area.id"
                          :value="seating_area.id"
                        >
                          {{ seating_area.name }}
                        </option>
                      </select>
          ...
          <div class="grid grid-cols-12 gap-6">
            ...
            >
              ...
              <div class="p-3">
                ...
                <div class="overflow-x-auto relative">
                  <table class="table-auto w-full dark:text-slate-300">
                    ...
                    >
                      ...
                      <tr v-for="employee in employees" :key="employee.id">
                        ...
                        <td class="p-2">
                          <div
                            v-if="employee.created_at"
                            class="text-center text-sky-500"
                          >
                            {{ moment(employee.created_at).format("Do MMM Y") }}
                          </div>
                        </td>
                        <td class="p-2">
                          <button
                  ...
                  <div class="mt-8">
                    <PaginationNumeric
                      @change-page="employeesChangePage"
                      :next_page="nextEmployeesPageUrl"
                      :prev_page="prevEmployeesPageUrl"
                      :from="employeesFrom"
                      :to="employeesTo"
                      :total_items="employeesTotalItems"
                      :links="employeesPagesLinks"
                    />
                  </div>
                </div>
              </div>
            ...
            >
              <div class="p-3">
                ...
                >
                  {{ employee_action == "create" ? "Add" : "Edit" }} Employee
                </h1>
                <!-- Form -->
                <form
                  ...
                  <div class="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        class="form-input w-full rounded-lg"
                        type="tel"
                        v-model="addEmployeePhoneNumber"
                      />
                    </div>
                    <div>
          ...
          <div
            ...
            v-if="restaurant.relationships.reviews.length > 0"
          >
            <div class="col-span-full xl:col-span-1">
              <div
                class="bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 h-fit"
              >
                ...
                <div class="flex flex-col space-y-2 p-3">
                  ...
                  <div
                    v-for="review in restaurant.relationships.reviews"
                    :key="review.id"
                  >
                    <div class="grid grid-cols-3">
          ...
          <div class="grid grid-cols-2 gap-6">
            ...
            <div class="col-span-full xl:col-span-1">
              ...
              >
                ...
                <div class="flex flex-col space-y-2 p-3">
                  <div
                    v-for="time in restaurant.relationships.operating_hours"
                    :key="time.id"
                  >
                    <div class="grid grid-cols-3">
                      <span>{{ time.day }}</span>
            ...
            <div class="col-span-full xl:col-span-1">
              ...
              >
                ...
                <div class="flex flex-col space-y-2 p-3">
                  <div
                    v-for="doc in restaurant.relationships.documents"
                    :key="doc.id"
                  >
          ...
          <div
            class="w-full"
            v-if="
              restaurant.attributes.latitude && restaurant.attributes.longitude
            "
          >
            <header
...
export default {
  ...
  setup() {
    ...
    const getMenu = () => {
      $http
        .get(`/restaurant/restaurant/${router.params.id}/menu`)
        .then((response) => {
          menu.value = [];
    ...
    const getRestaurant = () => {
      $http
        .get("/restaurant/restaurants/" + router.params.id)
        .then((response) => {
          restaurant.value = response.data.data;
          center.value = {
            lat: Number(restaurant.value.attributes.latitude),
            lng: Number(restaurant.value.attributes.longitude),
          };
          marker.value.push({
            position: {
              lat: Number(restaurant.value.attributes.latitude),
    ...
    const getReviews = () => {
      $http
        .get("/restaurant/restaurants/" + router.params.id + "/reviews")
        .then((response) => {
    ...
    const getPayments = () => {
      $http
        .get("/restaurant/restaurant/" + router.params.id + "/payments")
        .then((response) => {
          payments.value = [];
    ...
    const getOrders = () => {
      $http
        .get("/restaurant/restaurant/" + router.params.id + "/orders")
        .then((response) => {
          orders.value = [];
    ...
    const getRestaurantCategories = () => {
      $http
        .get("/restaurant/" + router.params.id + "/categories")
        .then((response) => {
    ...
    const getSeatingAreas = () => {
      $http.get("/seating-areas").then((response) => {
    ...
    const getRestaurantTables = () => {
      $http
        .get("/restaurant/restaurant/" + router.params.id + "/tables")
        .then((response) => {
    ...
    const getRestaurantEmployees = () => {
      $http
        .get(`/restaurant/employees/${router.params.id}`)
        .then((response) => {
          employees.value = [];
    ...
    const addTable = () => {
      ...
      if (table_action.value == "create") {
        $http
          .post("restaurant/" + router.params.id + "/tables/add", formData)
          .then(() => {
            getRestaurantTables();
            addTableName.value = "";
    ...
    const createMenu = () => {
      switch (action.value) {
        case "create menu":
          $http
            .post(`/restaurant/${router.params.id}/menu/add`, {
        ...
        case "edit menu":
          $http
            .post(`/restaurant/menu/${editMenuId.value}/update`, {
              title: addMenuTitle.value,
              description: addMenuDescription.value,
              categoryIds: addMenuCategories.value,
              subcategoryIds: addMenuSubcategories.value,
    ...
    const addEmployee = () => {
      ...
      if (employee_action.value == "create") {
        $http
          .post("restaurant/employees/" + router.params.id + "/add", formData)
          .then(() => {
            getRestaurantEmployees();
            addEmployeeFirstName.value = "";
            addEmployeeLastName.value = "";
        ...
        $http
          .post(
            "restaurant/employees/" + editUserId.value + "/update",
            formData
          )
          .then(() => {
            getRestaurantEmployees();
    ...
    watch(employeesSearch, async (newSearch, oldSearch) => {
      $http
        .get(`/restaurant/employees/${router.params.id}?search=${newSearch}`)
        .then((response) => {
          employees.value = [];
          employees.value = response.data.data.data;
          nextEmployeesPageUrl.value = response.data.data.next_page_url;
    ...
    const downloadFile = (file) => {
      $http
        .get(`/restaurant/documents/${file.id}/download`, {
